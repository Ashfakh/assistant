...
class WebBrowse:
    ...
    async def browse(self, query: str, website: str, prompt_str: str):
        print("prompt=============\n")
        print(prompt_str)
        prompt.messages[0].prompt[0].template = prompt_str
        print("==================\n")
...
#     asyncio.run(web_browse.browse("Play a kishore kumar song on youtube", "https://www.youtube.com/"))
